...
### Extra: Implementation of the `Newton Method`
...
Here is an example on how the Newton method can fail, and rapidly move out of our initial domain (where we can find the minimum).
