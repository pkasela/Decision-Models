...
print.solution <- function(result){
  ...
  if (result$convergence)
   ...
   msg  <- paste0(converge, " ",
              "The minimum was the point of coordinates (",
...
persp(x, y, z, phi = 30, theta = 60,col = "orange",xlab = "x",ylab = "y", zlab = "Distance", r=10, d=5)
...
ris_temp <- lapply(1:length(y), function(x) {
  gradientDescent(random.points[x,],fn.gr,lr = 0.1,max_iters = 1000,lr.decay = 0.0001)})
...
msg  <- paste0("The minimum is the point of coordinates (",
