...
Since the imporving trend didn't seem to stablize even in the end, it might indicate that we need more iteration before stopping the algorithm, also the initial population is incresed to 500 to have more variability for the algorithm.
